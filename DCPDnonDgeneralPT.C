...
_v_var(coupledValue("v")),// _v_var WILL HOLD TEMPERATURE VALUE
  ...
  _Ttrig(getParam<Real>("Ttrig")),_Tintl(getParam<Real>("Tintl")),E(getParam<Real>("_E")),n(getParam<Real>("_n")),m(getParam<Real>("_m")),cd(getParam<Real>("_cd")),ad(getParam<Real>("_ad")), _A(getMaterialPropertyByName<Real>("A"))
