...
#ifndef DCPDNONDGENERALPT_H
#define DCPDNONDGENERALPT_H
 ...
 */
class DCPDnonDgeneralPT : public Kernel
{
public:
   ...
   */
  DCPDnonDgeneralPT(const InputParameters & parameters);
...
private:
  Real _Ttrig,_Tintl,E,n,m,cd,ad;
