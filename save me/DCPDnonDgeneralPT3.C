...
Real falpha = pow(1.0-_u[_qp],n)*pow(_u[_qp],m)*(1/(1+exp(14.4778*(_u[_qp]-0.7705))));
    /* To be copied to QpJacobian */
...
Real falpha = pow(1.0-_u[_qp],n)*pow(_u[_qp],m)*(1/(1+exp(14.4778*(_u[_qp]-0.7705))));
    /* To be copied to QpJacobian */
Real dfalpha = - n*pow(1-_u[_qp],n-1)*pow(_u[_qp],m)*(1/(1+exp(14.4778*(_u[_qp]-0.7705))))+m*pow(_u[_qp],m-1)*pow(1.0-_u[_qp],n)*(1/(1+exp(14.4778*(_u[_qp]-0.7705))))-pow(1.0-_u[_qp],n)*pow(_u[_qp],m)*(14.4778*(exp(14.4778*(_u[_qp]-0.7705))))/(pow(1+exp(14.4778*(_u[_qp]-0.7705)),2));
//Cure function is product of K(T) and falpha
Real Pc = KT*falpha;
